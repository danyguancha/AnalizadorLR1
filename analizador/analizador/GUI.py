...
class GUI:
    ...
    def __init__(self, gui):
        ...
        def RealizarLR1():
            ...
            s.configure('Treeview.Heading', background="lightgray")
            #self.e = LR.LoopArray()
            label1 = Label(frame,text="los estados son {0}".format(len(self.arbol)) )
            label1.place(x=10, y=290)
            #print(rn)
            label = Label(frame,text=self.arbol)
        ...
        def crearTabla():
            ...
            tree = ttk.Treeview(frame, column=("C1","C2","C3","C4","C5","C6","C7","C8"),show='headings', height=15)
        ...
        frameBtn = LabelFrame(self.window, text="Menu opciones",
                              font=("Arial", 15), background="cyan")
        frameBtn.place(x=10, y=5, width=575, height=280)
        
        
        # ================ Contenedor para las tablas ================
        frame = LabelFrame(self.window, text="Visualización datos",
                           font=("Arial", 15), background="lightgray")
        frame.place(x=10, y=290, width=575, height=360)
        ...
        Button(frameBtn, text="Ver Gramatica", font=btn_font, background="#FFF7E9",
               command=Gramatica1).place(x=320, y=5, width=200, height=35)
        
        Button(frameBtn, text="Cargar Gramatica", font=btn_font, background="#FFF7E9",
               command=obtenerEntrada).place(x=140, y=100, width=150, height=35)
        
        Button(frameBtn, text="Preparar Gramatica", font=btn_font, background="#FFF7E9",
               command=PrepararGramaticaa).place(x=320, y=45, width=200, height=35)
        Button(frameBtn, text="Sacar LR1", font=btn_font, background="#FFF7E9",
               command=RealizarLR1).place(x=320, y=85, width=200, height=35)
        ...
        boton_nick = Button(frameBtn, text="Crear tabla", command=crearTabla)
        boton_nick.place(x=450, y=170)
        
        boton_nick = Button(frameBtn, text="Graficar Automata", command=graficarAutomata)
